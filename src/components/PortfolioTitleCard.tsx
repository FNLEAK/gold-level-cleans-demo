...
const tags = ['Before & After', 'Real Homes', 'Gold Standard']
        ...
        <div className="relative overflow-hidden rounded-[1.75rem] border border-white/[0.07] bg-gradient-to-b from-void-200/95 via-[#0c0c0c]/90 to-void-100/85 px-6 py-10 text-center backdrop-blur-md sm:px-10 sm:py-12 md:px-14 md:py-16">
          ...
          <div className="relative flex items-center justify-center gap-3 sm:gap-4">
            <span
              ...
              aria-hidden
            />
            <Sparkles className="h-3.5 w-3.5 shrink-0 text-gold-400/80" aria-hidden />
            <p className="font-display text-[11px] font-semibold uppercase tracking-[0.28em] sm:text-xs sm:tracking-[0.32em]">
              <ShinyText text="Our Work" className="font-display font-semibold uppercase" />
            </p>
            <Sparkles className="h-3.5 w-3.5 shrink-0 text-gold-400/80" aria-hidden />
            <span
          ...
          <h1 className="relative mt-6 text-balance font-display text-[clamp(1.85rem,5.5vw,3.75rem)] font-semibold leading-[1.08] tracking-tight text-white sm:mt-7">
            Homes we have{' '}
            <span className="relative inline-block">
              <ShinyText
                text="cleaned"
                className="font-display text-[clamp(1.85rem,5.5vw,3.75rem)] font-semibold"
                speed={4.5}
              />
            </span>
          </h1>
          ...
          <div
            className="mx-auto mt-5 flex w-fit items-center gap-3 sm:mt-6"
            aria-hidden
          >
          ...
          <GoldStreakLine wide className="absolute inset-x-0 bottom-0 z-10" duration={5} />
        </div>
      </GlowBorder>
    </motion.div>
  )
