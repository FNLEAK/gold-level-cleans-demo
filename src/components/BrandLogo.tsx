...
const webpBySize: Record<NonNullable<BrandLogoProps['size']>, { src: string; srcSet: string }> = {
  ...
  chat: { src: '/logo-96.webp', srcSet: '/logo-96.webp 96w' },
  ...
  return (
    <picture>
      ...
      <img
        ...
        width={320}
        height={480}
        className={`block bg-transparent object-contain ${resolved === 'chat' ? 'object-center' : 'object-left'} ${sizeClasses[resolved]}`}
        decoding="async"
