...
const ownerEmails = new Set([EMAIL.toLowerCase(), ADMIN_EMAIL])
...
export function SignInPage() {
  const { user, loading, signInCustomer, signInOwner } = useAuth()
    ...
    <AuthShell
      ...
      footer={
        <>
          ...
          <Link
            to="/owner/sign-in"
            className="font-semibold text-gold-400/80 hover:text-gold-400"
          >
            Owner / admin
          </Link>
        </>
